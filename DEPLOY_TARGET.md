...
- Repo: `einbuergerungstest-bw` (public, required for Pages on a free account)
- Vite `base`: `/einbuergerungstest-bw/`
- Live URL: `https://kailashbuki.github.io/einbuergerungstest-bw/`
